...
<main class="text-center">
    <form class="form-signin" action="/login/newuser" method="post">
    <h1 class="h3 mb-3 font-weight-normal">Please sign in</h1>
      <div class="name-group" style="width: 100%">
        ...
        name="name">
        <label for="secondName" class="sr-only">Sobrenome: </label>
        <input type="text" id="secondName" class="form-control m-2" placeholder="Sobrenome" required autofocus
      name="secondName">
      </div>
      <br>
